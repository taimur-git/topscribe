...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 23, 2023 at 07:02 PM
...
INSERT INTO `contest` (`id`, `title`, `description`, `start`, `end`, `capacity`, `judgeGroup`, `writerGroup`, `hostID`, `accepted`, `subcategoryID`) VALUES
(6, 'cool contest', 'description', '2023-03-06 00:45:04', '2023-03-06 00:45:04', NULL, NULL, NULL, 1, 0, 14),
(8, 'contest title', 'contest descrpition lorem ipsum', '2023-03-06 01:27:16', '2023-03-06 01:27:16', NULL, NULL, NULL, 2, 0, 16),
(9, 'awerqwer', 'asdfadsgfadfsgdfag', '2023-03-20 20:15:35', '2023-03-20 20:15:35', NULL, NULL, NULL, 1, 0, 16);
...
--
ALTER TABLE `userlist`
  ADD CONSTRAINT `fk_groupuserID` FOREIGN KEY (`userID`) REFERENCES `usernames` (`id`);
